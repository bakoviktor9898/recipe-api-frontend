...
const Recipe = () => {
  ...
  return (
    <div className="mt-14 flex items-center justify-center">
      <button
        onClick={() => navigate(-1)}
        className="absolute top-[115px] py-2 flex justify-center gap-1 items-center left-3  bg-teal-700 w-[87px] text-center text-white rounded-md"
      >
        <ArrowCircleLeftIcon className="w-7 h-7" />
        Vissza
      </button>
      <div className="w-[70%] flex flex-col items-center gap-4 bg-white rounded-lg">
